			...
			<div className="mr-6 mt-3 flex lg:mx-auto lg:my-auto">
				<div className="flex justify-end">
					<div className="flex lowercase">
						...
						<a href="https://www.linkedin.com/in/m-ghozi" target="_blank" className="p-4 text-white">
							<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 448 512">
								<path
									fill="#dfdddd"
									d="M100.28 448H7.4V149.7h92.88zM53.79 108.1c-31.6 0-57.2-25.9-57.2-57.8C-3.41 18.3 22.2-7.6 53.79-7.6c31.8 0 57.4 25.9 57.4 57.7 0 31.9-25.5 57.8-57.4 57.8zm394.28 339.9h-92.78V303c0-34.6-.7-79.1-48.1-79.1-48.2 0-55.6 37.6-55.6 76.6v147.5H159.4V149.7h89.1v40.7h1.3c12.4-23.4 42.7-48.1 87.9-48.1 94.1 0 111.4 61.9 111.4 142.3V448z"
								/>
							</svg>
						</a>
					</div>
